...
<div class="login col-sm-10 text-center">
    ...
    <div class="dashbox">
        ...
        <div class="item-card">
            <a href="<?php echo base_url() . "staff/mystudent/" . $admission_no; ?>">Student Details</a><br>
            <a href="<?php echo base_url() . "staff/view_request/" . $arequest_id; ?>">View request</a><br>
            <?php if ($status->office == 1) { ?>
                <a href="<?php echo base_url() . "pdf_generate/print_req/" . $arequest_id; ?>">Print request</a><br>
                ...
                <?php if ($status->issued == 1 && $status->receipt == 1 && $requests->return_applicable == 1 && $requests->returned == 0) {
                    echo "<a href='" . base_url() . "staff/verify_return/" . $arequest_id . "'>Verify return</a><br>";
                }
