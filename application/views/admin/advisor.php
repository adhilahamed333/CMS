...
<div class="login col-sm-10 text-left" style="float:left;overflow-y:auto;height:100%;">
    <div class="dashbox">
        <h2>Enter Advisor details</h2>
        <?php echo form_open_multipart('admin/advisor'); ?>
        ...
        <div class="item-card"><br>
            ...
            <div class="form-group">
                ...
                <input type="text" name="branch_in_charge" required><br>
            </div>
            <div class="form-group">
                <label>Batch in Charge:</label>
                <input type="text" name="batch_in_charge" required><br>
            </div>
        </div>
        <span class="red-span">
            <?php if ($error_msg) {
